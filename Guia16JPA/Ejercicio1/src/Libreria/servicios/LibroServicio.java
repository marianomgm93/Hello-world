...
public class LibroServicio {
    ...
    public void buscarLibroMenu() throws Exception {
        ...
        switch (val) {
            case 1:
                ...
                System.out.println(ldao.buscarPorId(isbn));
                break;
            case 2:
                System.out.println("Ingrese Titulo del libro");
                String titulo = sc.next();
                System.out.println(ldao.buscarPorTitulo(titulo));
                break;
            case 3:
                System.out.println("Ingrese nombre de Autor");
                String nombre = sc.next();
                List<Libro> libros = ldao.buscarPorAutor(nombre);
                System.out.println(libros);
                break;
            case 4:
                System.out.println("Ingrese editorial del Libro");
                String editorial = sc.next();
                List<Libro> librosPorEditorial = ldao.buscarPorEditorial(editorial);
                System.out.println(librosPorEditorial);
                break;
            default:
    ...
    public Libro buscarLibro() throws Exception {
        System.out.println("Ingrese ISBN del libro");
        Long isbn = sc.nextLong();
        return ldao.buscarPorIsbn(isbn);
    }
