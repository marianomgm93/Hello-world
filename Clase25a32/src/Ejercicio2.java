...
public class Ejercicio2 {
    ...
    La clase debe tener un constructor vacío, getters y setters.  En el constructor vacío 
    se usará el Math.random para generar los dos números. Crear una clase ParDeNumerosService, 
...
Método calculaRaiz, para calcular la raíz cuadrada del menor de los dos valores. Antes de calcular la raíz 
    ...
    public static void main(String[] args) {
        ...
        serv.mostrarValores(par);
        serv.calcularPotencia(par);
        serv.calculaRaiz(par);
    }
