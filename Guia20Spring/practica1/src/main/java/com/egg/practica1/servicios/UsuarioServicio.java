...
import com.egg.practica1.enumeraciones.Rol;
import com.egg.practica1.excepciones.MiException;
import com.egg.practica1.repositorios.UsuarioRepositorio;
...
public class UsuarioServicio implements UserDetailsService {
    ...
    private void validar(String nombre, String email, String password, String password2) throws MiException {
        ...
        if (password.isEmpty() || password == null || password.length() <= 5) {
            throw new MiException("La contraseña no puede estar vacia y debe contener mas de 5 caracteres");
        }
