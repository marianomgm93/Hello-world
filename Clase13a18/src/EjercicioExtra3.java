...
public class EjercicioExtra3 {
     ...
     * número limitado de intentos y recibe una pista de "más alto" o "más bajo" después de 
     * cada intento. El juego termina cuando el segundo jugador adivina el número o se queda sin 
