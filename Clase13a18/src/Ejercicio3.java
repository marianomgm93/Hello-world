...
public class Ejercicio3 {
    public static void main(String[] args) {
      ...
      */
        ...
        System.out.println(cuenta.sumar());
        System.out.println(cuenta.restar());
        System.out.println(cuenta.multiplicar());
        System.out.println(cuenta.dividir());
